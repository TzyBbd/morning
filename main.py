...
from wechatpy
import WeChatClient
from wechatpy.client.api
import WeChatMessage, WeChatTemplate
import requests
import os
import random
today = datetime.now()
...
return weather['weather'], math.floor(weather['temp']), weather[
        'wind'], weather['humidity'], weather_two['weather'],
    weather_three['weather']
def get_count():
...
wea, temperature, wind_speed, humidity, tomorrow, after_tomorrow =
    get_weather()
data = {
    "city":
    {
